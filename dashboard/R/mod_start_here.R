    ...
    card(
      ...
      card_body(
        ...
        p(sprintf(paste("The model was trained on the four countries' national biomarker surveys (The Gambia 2018, Ghana 2017,",
                        ...
                        "climate, soil, crops, livestock, malaria and other disease, market prices and summaries from household",
                        "surveys. Each group is condensed to a few summary scores, each score is weighted by how well it tracked",
