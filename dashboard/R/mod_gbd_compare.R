    ...
    card(
      ...
      card_body(
        ...
        methods_note(
          ...
          tags$br(), tags$br(),
          "When the two estimates agree, this provides cross-validation of national-level ",
          "burden. When they disagree, the divergence highlights where one method may be ",
    ...
    card(
      ...
      card_body(
        ...
        methods_note(
          ...
          "broader proxy predictor set. The two approaches are best understood as ",
          "complementary rather than competing — GBD provides comparable cross-country ",
