...
mod_national_burden_ui <- function(id) {
  ...
  layout_columns(
    ...
    div(
      ...
      p(strong("How much population burden is masked by national averages?"),
        " For each outcome, this section quantifies the population living in ",
        "districts where the local prevalence is materially different from ",
        "the country average — individuals whose burden may be ",
        "mischaracterized by country-level estimates."),
    ...
    card(
      ...
      card_body(
        ...
        methods_note(
          ...
          "estimate the “hidden burden population” — individuals whose local risk is ",
          "materially mischaracterized by national-level estimates. ",
          tags$br(), tags$br(),
    ...
    card(
      ...
      card_body(
        ...
        methods_note(
          ...
          "estimate, computed via the ", tags$code("srvyr"), " package. This serves as ",
