        ...
        layout_columns(
          ...
          radioButtons(ns("pop_year"), "Population year",
                       choices = c("Survey year (matched to data)" = "survey",
                                   "2023 population (rates held at survey year)" = "2023"),
                       selected = "survey",
                       inline = FALSE)
        ),
        div(style = "font-size:0.82em; color:#6c757d; margin:-4px 0 8px;",
            "The 2023 option scales counts to projected 2023 population (uniform ",
            "country-wide growth); deficiency rates are held at the survey year, so ",
            "this is not an updated 2023 measurement of deficiency."),
