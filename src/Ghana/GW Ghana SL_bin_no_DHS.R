...
Xvars = c("dataid","Admin1","gw_month", mics_vars, ihme_vars, lsms_vars, map_vars, wfp_vars, flunet_vars, gee_vars)
...
saveRDS(res3, file = here("results/models/res_bin_GW_Ghana_SL_child_vitA_noDHS.rds"))

res6=try(DHS_SL(d=df_mom_VitA, outcome="gw_wVAD", population="children", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res6, file = here("results/models/res_bin_GW_Ghana_SL_women_vitA_noDHS.rds"))

res9=try(DHS_SL(d=df_mom_b12, outcome="gw_wB12Def", population="women", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res9, file = here("results/models/res_bin_GW_Ghana_SL_women_b12_noDHS.rds"))
...
saveRDS(res12, file = here("results/models/res_bin_GW_Ghana_SL_women_folate_noDHS.rds"))

res15=try(DHS_SL(d=df_child_iron, outcome="gw_cIDAdjBrinda", population="women", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res15, file = here("results/models/res_bin_GW_Ghana_SL_child_iron_noDHS.rds"))
...
saveRDS(res18, file = here("results/models/res_bin_GW_Ghana_SL_mom_iron_noDHS.rds"))
