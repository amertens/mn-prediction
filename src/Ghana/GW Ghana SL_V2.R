...
res=try(DHS_SL(d=df_child_VitA, outcome="gw_cRBPAdjBrinda", population="children", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res, file = here("results/models/res_GW_Ghana_SL_child_vitA_v2.rds"))

res=try(DHS_SL(d=df_mom_VitA, outcome="gw_wRBP",  population="women", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res, file = here("results/models/res_GW_Ghana_SL_women_vitA_v2.rds"))

res=try(DHS_SL(d=df_mom_b12, outcome="gw_wB12",  population="women", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res, file = here("results/models/res_GW_Ghana_SL_women_b12_v2.rds"))

res=try(DHS_SL(d=df_mom_folate, outcome="gw_wFolate", population="women", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res, file = here("results/models/res_GW_Ghana_SL_women_folate_v2.rds"))

res=try(DHS_SL(d=df_child_iron, outcome="gw_r_crpagp_sf2", population="children", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res, file = here("results/models/res_GW_Ghana_SL_child_iron_v2.rds"))

res=try(DHS_SL(d=df_mom_iron, outcome="gw_r_crpagp_sf2", population="women", Xvars=Xvars, id=id, folds=Vfolds, CV=CVsetting, sl=slmodel))
saveRDS(res, file = here("results/models/res_GW_Ghana_SL_mom_iron_v2.rds"))
