...
res = readRDS(here("results/models/res_Malawi_SL_mom_iron_bin.rds"))
...
saveRDS(res_vim_domains, here("results/vim/res_GW_Malawi_SL_mom_iron_vim_variable_domains.rds"))
...
saveRDS(res_vim_diff_data_sources, here("results/vim/res_GW_Malawi_SL_mom_iron_vim_data_sources.rds"))
