...
res = readRDS(here("results/models/res_bin_GW_Ghana_SL_women_b12_v2.rds"))
...
variable_domains_nogw <- c(dhs_var_list, list(
  ...
  # # ============================================================
  # # 1. DHS aggregated indicators
  # # ============================================================
  #
  # # ---- Survey metadata & geography
  # dhs_survey_metadata = grep(
  #   "ISO|FIPS|SVY|REG|LEVEL|CNTRY|MAP",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Fertility & reproductive history
  # dhs_fertility = grep(
  #   "FRTR|FRTY|TFR|CBR|GFR|BINT|BORD|PPID|BBAY|AAFB|TNPG|PRGO",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Family planning (use, unmet need, method mix)
  # dhs_family_planning = grep(
  #   "^dhs.*FP_",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Maternal health & ANC
  # dhs_maternal_health = grep(
  #   "^dhs.*RH_ANC",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Delivery & postnatal care
  # dhs_delivery_postnatal = grep(
  #   "^dhs.*RH_DEL|^dhs.*RH_PC",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Child mortality
  # dhs_child_mortality = grep(
  #   "^dhs.*CM_",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Child illness & care-seeking
  # dhs_child_illness = grep(
  #   "^dhs.*CH_(ARI|FEVR|DIAR|DIAT|KORS)",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Child vaccination
  # dhs_child_vaccination = grep(
  #   "^dhs.*CH_VACC",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Child nutrition (anthropometry)
  # dhs_child_anthro = grep(
  #   "^dhs.*CN_NUTS",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  ...
  # dhs_iycf = grep(
  #   "^dhs.*CN_(BRFI|BFSS|BFDR|IYCF|IYCC)",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Child micronutrient interventions
  # dhs_child_mn_interventions = grep(
  #   "^dhs.*CN_MIAC",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Iodine & salt iodization
  # dhs_iodine = grep(
  #   "^dhs.*IOD",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Adult nutrition & BMI
  # dhs_adult_nutrition = grep(
  #   "^dhs.*AN_NUTS",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Adult anemia & micronutrients
  # dhs_adult_anemia = grep(
  #   "^dhs.*AN_ANEM|^dhs.*AN_MIAM",
  #   metadata$dhs_vars, value = TRUE
  # ),
  #
  # # ---- Malaria prevention & exposure
  # dhs_malaria = grep(
  #   "^dhs.*ML_",
  #   metadata$dhs_vars, value = TRUE
  # ),
  ...
  #       "ISO|FIPS|SVY|REG|LEVEL|CNTRY|MAP",
  #       "FRTR|FRTY|TFR|CBR|GFR|BINT|BORD|PPID|BBAY|AAFB|TNPG|PRGO",
  #       "^dhs.*FP_","^dhs.*RH_","^dhs.*CM_","^dhs.*CH_",
  #       "^dhs.*CN_","^dhs.*AN_","^dhs.*ML_",
  #       "education|EDUC","WAT|SAN"
  #     ),
  #     function(p) grep(p, metadata$dhs_vars, value = TRUE)
  #   ))
  # ),
...
saveRDS(res_vim_domains, here("results/vim/res_GW_Ghana_SL_mom_b12_vim_variable_domains.rds"))
...
saveRDS(res_vim_diff_data_sources, here("results/vim/res_GW_Ghana_SL_mom_b12_vim_data_sources.rds"))
...
saveRDS(res_vim, here("results/vim/res_GW_Ghana_SL_mom_b12_vim_individual.rds"))
