resfull =readRDS(file = here("results/models/res_GW_transportability_SL_women_vitA_gee_only.rds"))
res_ghana =readRDS(file = here("results/models/res_GW_Ghana_SL_women_vitA_gee_only.rds"))
res_gambia =readRDS(file = here("results/models/res_GW_Gambia_SL_women_vitA_gee_only.rds"))
res_malawi =readRDS(file = here("results/models/res_GW_Malawi_SL_women_vitA_gee_only.rds"))
res_sierraleone =readRDS(file = here("results/models/res_GW_SierraLeone_SL_women_vitA_gee_only.rds"))
...
plotdf= bind_rows(
  data.frame(country="Ghana", Covariates="GEE only", MSE=res_ghana$cv_risk_w_sl_revere$MSE[nrow(res_ghana$cv_risk_w_sl_revere)], SE=res_ghana$cv_risk_w_sl_revere$se[nrow(res_ghana$cv_risk_w_sl_revere)]),
  data.frame(country="Gambia", Covariates="GEE only", MSE=res_gambia$cv_risk_w_sl_revere$MSE[nrow(res_gambia$cv_risk_w_sl_revere)], SE=res_gambia$cv_risk_w_sl_revere$se[nrow(res_gambia$cv_risk_w_sl_revere)]),
  data.frame(country="Malawi", Covariates="GEE only", MSE=res_malawi$cv_risk_w_sl_revere$MSE[nrow(res_malawi$cv_risk_w_sl_revere)], SE=res_malawi$cv_risk_w_sl_revere$se[nrow(res_malawi$cv_risk_w_sl_revere)]),
  data.frame(country="Sierra Leone", Covariates="GEE only", MSE=res_sierraleone$cv_risk_w_sl_revere$MSE[nrow(res_sierraleone$cv_risk_w_sl_revere)], SE=res_sierraleone$cv_risk_w_sl_revere$se[nrow(res_sierraleone$cv_risk_w_sl_revere)]),
  ...
  data.frame(country="All", Covariates="GEE only", MSE=resfull$cv_risk_w_sl_revere$MSE[nrow(resfull$cv_risk_w_sl_revere)], SE=resfull$cv_risk_w_sl_revere$se[nrow(resfull$cv_risk_w_sl_revere)])
)
