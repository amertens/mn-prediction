...
saveRDS(res, file = here("results/models/res_bin_GW_Gambia_SL_child_iron_no_DHS.rds"))
...
saveRDS(res, file = here("results/models/res_bin_GW_Gambia_SL_mom_iron_no_DHS.rds"))
...
saveRDS(res, file = here("results/models/res_bin_GW_Gambia_SL_child_vitA_no_DHS.rds"))
...
saveRDS(res, file = here("results/models/res_bin_GW_Gambia_SL_women_vitA_no_DHS.rds"))
