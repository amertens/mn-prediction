...
ghana_2017 <- flunet_data %>%
  filter(COUNTRY_CODE == "SLE" & ISO_YEAR == 2012) %>%
  arrange(ISO_WEEK)
...
write.csv(weekly_summary, here("data/FluNet/Sierra Leone/SL_2012_weekly_flu_summary.csv"), row.names = FALSE)
write.csv(overall_summary,  here("data/FluNet/Sierra Leone/SL_2012_overall_flu_summary.csv"), row.names = FALSE)
