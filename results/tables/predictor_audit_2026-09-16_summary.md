...
`predictors_admin2_shared.csv`: 554 Admin-2 rows x 575 predictors, 4 countries (Gambia, Ghana, Malawi, SierraLeone).

| flag | columns |
|---|---:|
| present in all 4 countries | 517 |
| partial coverage (< 4 countries) | 58 |
| national constants (no within-country variation) | 42 |
| completeness < 70% | 47 |
| value-identical duplicates | 0 |
| survey-derived (DHS) | 150 |
| modelled outcome-adjacent surfaces (V2_DROP_MODELLED sensitivity) | 48 |
| data year >= 3 years from the survey in some country (TA-01) | 305 |
...
| SoilGrids / iSDA | open | 45 | 1 | 45 | 45 | 0 | 0 | 0 | 0 | 0 | - |
| IHME (modelled surfaces) | open | 34 | 7 | 33 | 34 | 0 | 0 | 0 | 34 | 0 | 1 |
...
| HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | survey_public | 15 | 1 | 2 | 15 | 0 | 12 | 0 | 0 | 14 | 3 |
...
| ACLED (Armed Conflict Location & Event Data Project) export | open | 8 | 1 | 7 | 8 | 0 | 1 | 0 | 0 | 0 | 0 |
...
| hces_year | 14 | `hces_food_share` | Gambia=2015;Ghana=2016;Malawi=2016;SierraLeone=2011 | 3 |
...
| acled_civilian_targeting_36m | ACLED (Armed Conflict Location & Event Data Project) export | Gambia;Ghana;Malawi;SierraLeone | 0.25 |
| hces_log_cons_pae_rel | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Ghana;Malawi;SierraLeone | 0.93 |
| hces_hdds | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_asf | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_fish | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_meat | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_eggs | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_dairy | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_pulses_nuts | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_fruit | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_veg | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_dgl | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_any_vita_fv | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
| hces_asf_purchase_share | HCES microdata (IHS4, IHS 2015/16, SLIHS 2011, GLSS7) | Gambia;Malawi;SierraLeone | 0.53 |
